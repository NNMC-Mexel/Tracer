...
export interface ApiCriterionCriterion extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u041A\u0440\u0438\u0442\u0435\u0440\u0438\u0439 (\u0432\u043E\u043F\u0440\u043E\u0441) \u043E\u043F\u0440\u043E\u0441\u043D\u0438\u043A\u0430';
...
export interface ApiDepartmentDepartment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u0421\u0442\u0440\u0443\u043A\u0442\u0443\u0440\u043D\u043E\u0435 \u043F\u043E\u0434\u0440\u0430\u0437\u0434\u0435\u043B\u0435\u043D\u0438\u0435 \u043E\u0440\u0433\u0430\u043D\u0438\u0437\u0430\u0446\u0438\u0438';
...
export interface ApiEmployeeEmployee extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u0421\u043E\u0442\u0440\u0443\u0434\u043D\u0438\u043A \u043E\u0440\u0433\u0430\u043D\u0438\u0437\u0430\u0446\u0438\u0438 (\u0441\u043F\u0440\u0430\u0432\u043E\u0447\u043D\u0438\u043A \u0434\u043B\u044F \u043F\u0440\u043E\u0432\u0435\u0434\u0435\u043D\u0438\u044F \u0442\u0440\u0435\u0439\u0441\u0435\u0440\u043E\u0432)';
...
export interface ApiOrganizationOrganization
  ...
  info: {
    description: '\u041E\u0440\u0433\u0430\u043D\u0438\u0437\u0430\u0446\u0438\u044F (\u044E\u0440\u0438\u0434\u0438\u0447\u0435\u0441\u043A\u043E\u0435 \u043B\u0438\u0446\u043E)';
...
export interface ApiQuestionnaireQuestionnaire
  ...
  info: {
    description: '\u041E\u043F\u0440\u043E\u0441\u043D\u0438\u043A (\u0442\u0440\u0435\u0439\u0441\u0435\u0440): \u043D\u0430\u0431\u043E\u0440 \u043A\u0440\u0438\u0442\u0435\u0440\u0438\u0435\u0432 \u0438 \u0442\u0438\u043F \u0441\u0443\u0431\u044A\u0435\u043A\u0442\u0430 \u043E\u0446\u0435\u043D\u043A\u0438';
  ...
  attributes: {
    ...
    slug: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    subjectType: Schema.Attribute.Enumeration<['department', 'employee']> &
      Schema.Attribute.Required &
...
export interface ApiTracerSessionTracerSession
  extends Struct.CollectionTypeSchema {
  collectionName: 'tracer_sessions';
  info: {
    description: '\u041F\u0440\u043E\u0432\u0435\u0434\u0451\u043D\u043D\u044B\u0439 \u0442\u0440\u0435\u0439\u0441\u0435\u0440: \u043E\u043F\u0440\u043E\u0441\u043D\u0438\u043A, \u043E\u0442\u0434\u0435\u043B\u0435\u043D\u0438\u0435, \u0430\u0443\u0434\u0438\u0442\u043E\u0440, \u0434\u0430\u0442\u0430 \u0438 \u0441\u0443\u0431\u044A\u0435\u043A\u0442\u044B \u043E\u0446\u0435\u043D\u043A\u0438';
    displayName: '\u0422\u0440\u0435\u0439\u0441\u0435\u0440 (\u0441\u0435\u0441\u0441\u0438\u044F)';
    pluralName: 'tracer-sessions';
    singularName: 'tracer-session';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    auditor: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    auditorName: Schema.Attribute.String;
    complianceLevel: Schema.Attribute.Enumeration<['high', 'medium', 'low']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    questionnaire: Schema.Attribute.Relation<
      ...
      'api::questionnaire.questionnaire'
    >;
    scorePercent: Schema.Attribute.Decimal;
    subjects: Schema.Attribute.Relation<
      'oneToMany',
      'api::tracer-subject.tracer-subject'
    >;
...
export interface ApiTracerSubjectTracerSubject
  extends Struct.CollectionTypeSchema {
  collectionName: 'tracer_subjects';
  info: {
    description: '\u041E\u0446\u0435\u043D\u0438\u0432\u0430\u0435\u043C\u044B\u0439 \u0441\u0443\u0431\u044A\u0435\u043A\u0442 (\u0441\u043E\u0442\u0440\u0443\u0434\u043D\u0438\u043A \u0438\u043B\u0438 \u043F\u043E\u0434\u0440\u0430\u0437\u0434\u0435\u043B\u0435\u043D\u0438\u0435) \u0432 \u0440\u0430\u043C\u043A\u0430\u0445 \u0441\u0435\u0441\u0441\u0438\u0438 \u0442\u0440\u0435\u0439\u0441\u0435\u0440\u0430';
    displayName: '\u0421\u0443\u0431\u044A\u0435\u043A\u0442 \u0442\u0440\u0435\u0439\u0441\u0435\u0440\u0430';
    pluralName: 'tracer-subjects';
    singularName: 'tracer-subject';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    departmentSnapshot: Schema.Attribute.String;
    ...
    positionSnapshot: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    scorePercent: Schema.Attribute.Decimal;
