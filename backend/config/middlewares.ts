...
const config: Core.Config.Middlewares = [
  ...
  'strapi::security',
  {
    ...
    config: {
      ...
      origin: '*',
      // По умолчанию Strapi кэширует preflight на 1 год (31536000) — из-за этого
      // старый (запрещающий) ответ CORS «залипает» в браузере после исправления.
      // Ставим 10 минут, чтобы правки CORS применялись быстро.
      maxAge: 600,
    },
  },
  'strapi::poweredBy',
